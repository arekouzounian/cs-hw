...
void Handler::set_next(Handler* next) { next_ = next; }

Handler::HANDLER_STATUS_T
Handler::handle(SearchEng* eng, const std::string& cmd, std::istream& instr, std::ostream& ostr) {
